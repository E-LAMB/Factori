...
public class BuildTile : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (currently_building)
        {
            ...
            showup.color = new Vector4 (1f, 1f, 1f, 1f);
        } else
        {
        ...
        if ((currently_building && (Input.GetMouseButtonDown(0) || Input.GetMouseButtonDown(1))) || (currently_building && (Input.GetMouseButton(0) || Input.GetMouseButton(1)) && build_held > 0.25f) && Vector3.Distance(build_trans.position, previous_build) > 0.2f)
        {
